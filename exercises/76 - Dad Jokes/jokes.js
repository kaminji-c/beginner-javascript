...
async function handleClick(){ 
  ...
  jokeButtonSpan.textContent = randomItemFromArray(buttonText, jokeButtonSpan.textContent); //second arg, whatever the button says don't return that one to me because thats already the current one
}
